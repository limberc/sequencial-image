...
class CIFARLightning(LightningModule):
    ...
    def __init__(
        ...
        self.model = TransformerModel(ntoken=32 * 32, ninp=3, nhead=nhead, nhid=nhid, nlayers=nlayer,
                                      dropout=dropout)
    ...
    def add_model_specific_args(parent_parser):  # pragma: no-cover
        ...
        parser.add_argument('--nhead', default=4, type=int, metavar='N',
                            help='number of head in Transformer')
        parser.add_argument('--nhid', default=800, type=int, metavar='N',
                            help='number of hidden layer in Transformer')
        parser.add_argument('--nlayer', default=4, type=int, metavar='N',
                            help='number of layer in Transformer')
        parser.add_argument('--dropout', default=0.5, type=float, metavar='N',
...
def main(args: Namespace) -> None:
    ...
    model = CIFARLightning(**vars(args))
...
def run_cli():
    ...
    parent_parser.add_argument('--dataset', type=str, default='cifar10',
                               help='CIFAR10 or CIFAR100')
    parent_parser.add_argument('-e', '--evaluate', dest='evaluate', action='store_true',
                               help='evaluate model on validation set')
    parent_parser.add_argument('--seed', type=int, default=42,
                               help='seed for initializing training.')
    parser = CIFARLightning.add_model_specific_args(parent_parser)
    parser.set_defaults(
        profiler=True,
        deterministic=True,
        max_epochs=200,
